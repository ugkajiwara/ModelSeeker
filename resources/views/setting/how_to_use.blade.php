...
@section('content')
    ...
    <div class="container how_to_use">

        <h2 class="text-center">Model Seekerの使い方</h2>

        <h4 class="text-center">管理側ページの利用に関して</h4>
        ...
        <h4 class="mt-5 text-center">予約者側ページの利用に関して</h4>
        ...
        <div class="row justify-content-center py-3">
            ...
            <div class="col-7 mt-sm-3">
                ...
                <p>カレンダーにて、日付、メニューを選択後、左画像のような予約者情報入力画面へと遷移します。<br>
                   「募集しているメニューの登録」で記載したように、ここでは条件がある場合、その承認が必須となっております。
                    メニュー登録の際に間違いが無いようにお気をつけください。</p>
            </div>
        </div>
